...
/**
 * Enrichment approve: proxy POST to backend /artifacts/{artifactId}/enrichment/{cycleId}/approve.
 * Body: { artifact_types, thread_id?, decision_id? }.
...
export async function POST(
  ...
  try {
    ...
    const targetUrl = `${baseUrl}/artifacts/${encodeURIComponent(artifactId)}/enrichment/${encodeURIComponent(cycleId)}/approve`;
    ...
    console.error("[PROXY] Enrichment approve failed:", error);
